...
const Carrusel = () => {
    ...
    return (
        <div id="hero-slides" style={{ '--page': currentPage }} ref={carruselRef}>
            <div id="header" >
                <div className='heading-text neon-text ' style={{ padding: "0px 1.5vw 0px 0px" }}>
                    Top
                </div>
                <div className='heading-text x-safe-text' style={{ padding: "0px 1.5vw 0px 0px" }}>
                    10
                </div>
                <div className='heading-text neon-text'>
                    Vulnerabilidades
                </div>
            </div >
